...
public class DrivingSimulation {
    ...
    public static void changeGear() {
        ...
        String previousGear = gear;
        System.out.print("Enter gear (P, D, R): ");
        gear = keyBoard.next();
        System.out.printf("Changed gear from %s to %s ", previousGear, gear);
    }
    ...
    public static void accelerate() {
        ...
        if (isEngineOn == true && gear.equals("D")) {
            ...
            System.out.printf("Acceleration is not possible becuase engine is %s and gear is %s", isEngineOn, gear);
        }
    }
    ...
    public static void brake() {
        ...
        if (isEngineOn) {
            ...
            System.out.printf("Brake is not possible becuase engine is %s and gear is %s", message, gear);
        }
    }
